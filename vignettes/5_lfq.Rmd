...
FCstatistics <- function(P){
 ...
 rv <- data.frame(ConcGr=P.mean$ConcGr, mean=P.mean$mean, sd=P.sd$sd, cv=P.sd$sd/P.mean$mean, length=P.length$length, median=P.median$median)
 rv
}
```
