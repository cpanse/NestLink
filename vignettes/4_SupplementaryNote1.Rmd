...
bibliography:
  - NestLink.bib
abstract: |
  The following content was used for to compile the *Supplementary Note 1* in @NestLink (under review  NMETH-A35040).
vignette: |
  %\VignetteIndexEntry{4. Control experiment to assess robustness of protein detection via flycodes}
...
```{r NestLink_relative_flycode_simulation, fig.retina=3, fig.height=4, fig.width=12, fig.path='Figs/'}
SIM <- P.replicate
