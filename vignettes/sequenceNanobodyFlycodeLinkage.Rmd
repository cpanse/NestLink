...
This pipeline processes raw reads from NGS (fastq-format) to generate the flycode to nanobody linkage used in the proteomics analysis.
...
```{r setupParameter}
param <- list()
param[['nReads']] <- 100 #Number of Reads to process
