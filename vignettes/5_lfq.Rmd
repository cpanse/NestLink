---
title: "5. Postvalidation of Quantitative Flycode Results"
author:
- name: Pascal Egloff
...
```{r}
kable(FCstatistics2(P, mode = 'bio'))
```

```{r}
kable(FCstatistics2(P, mode = 'tech_coli'))
```

```{r}
kable(FCstatistics2(P, mode = 'tech_smeg'))
```
